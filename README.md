...
Full derivation is in the report; the short version is that instead of solving one big sparse KKT system directly, I reduce it down to a smaller system in the dual variable, which is much faster.
